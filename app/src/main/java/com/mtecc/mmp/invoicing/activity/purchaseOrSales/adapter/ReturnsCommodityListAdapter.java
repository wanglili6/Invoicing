...
public class ReturnsCommodityListAdapter extends BaseAdapter {
    private Context mContext;
    private List<TransferCommodityBean.DataBean> mList;
    private ListView lv;
    private String type;

    public ReturnsCommodityListAdapter(Context mContext, List<TransferCommodityBean.DataBean> mList, ListView commodityListRecycleView, String type) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.llSnum.setVisibility(View.GONE);
        if (type.equals("show")) {
