...
import com.mtecc.mmp.invoicing.activity.purchaseOrSales.adapter.SelectBatchAdapter;
...
public class SelectBatchListActivity extends BaseActivity {
    ...
    public void initParms(Bundle parms) {
        ...
        useSystemUtils = new UseSystemUtils(SelectBatchListActivity.this);
        ...
        batchListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(SelectBatchListActivity.this, SeeBatchMsgActivity.class);
    ...
    private void mapMlist() {
        for (int i = 0; i < mList.size(); i++) {
            ...
            batchBean.setBatchdate(value.getBatchdateStr() + "");
            batchBean.setEnterprice(value.getEnterprice());
            batchBean.setPbatchid(value.getPbatchid());
            batchBean.setIsdel(value.getIsdel());
            batchBean.setBhid(value.getBhid());
            batchBean.setRemark(value.getRemark());
            batchBean.setSaleprice(value.getSaleprice());
            batchBean.setSaleprice(value.getSellprice());
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_select_sure:
                mapMlist();
                Intent batchintent = new Intent(SelectBatchListActivity.this, SelectCommodityListActivity.class);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        try {
                            ...
                            Toast.makeText(SelectBatchListActivity.this, R.string.net_error, Toast.LENGTH_SHORT).show();
                        } catch (Exception e1) {
