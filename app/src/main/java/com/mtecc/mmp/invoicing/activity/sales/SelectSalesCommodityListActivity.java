...
import com.mtecc.mmp.invoicing.activity.sales.adapter.SelectCommodityListAdapter;
 ...
 * 选择商品列表
 */
public class SelectSalesCommodityListActivity extends BaseActivity {
...
//        mapMlist();
        ...
        commodityListAdapter = new SelectCommodityListAdapter(this, mList, commodityListRecycleView);
        ...
        commodityListRecycleView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //选择批次
                Intent intent = new Intent(SelectSalesCommodityListActivity.this, SelectSalesBatchListActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_select_sure:
                ...
                LogUtils.i("选择的商品" + s);
                mapMlist();
                Intent batchintent = new Intent(SelectSalesCommodityListActivity.this, AddSalesActivity.class);
                ...
                case 1:
                    ...
                    if (null != data) {
                        ...
                        if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                            ...
                            Toast.makeText(SelectSalesCommodityListActivity.this, "解析二维码失败!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    break;
                case 2:
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        try {
                            ...
                            Toast.makeText(SelectSalesCommodityListActivity.this, R.string.net_error, Toast.LENGTH_SHORT).show();
                        } catch (Exception e1) {
