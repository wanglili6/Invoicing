...
import com.mtecc.mmp.invoicing.activity.transfer.adapter.TransferSelectCommodityListAdapter;
 ...
 * 选择商品列表
 */
public class TransferommodityListActivity extends BaseActivity {
    ...
    private TransferSelectCommodityListAdapter commodityListAdapter;
...
//        mapMlist();
        ...
        commodityListAdapter = new TransferSelectCommodityListAdapter(this, mList, commodityListRecycleView,type);
        ...
        commodityListRecycleView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //选择批次
                Intent intent = new Intent(TransferommodityListActivity.this, TransferBatchListActivity.class);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_select_sure:
                ...
                LogUtils.i("选择的商品" + s);
                mapMlist();
                Intent batchintent = new Intent(TransferommodityListActivity.this, AddTransferActivity.class);
                ...
                case 1:
                    ...
                    if (null != data) {
                        ...
                        if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                            ...
                            Toast.makeText(TransferommodityListActivity.this, "解析二维码失败!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    break;
                case 2:
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        try {
                            ...
                            Toast.makeText(TransferommodityListActivity.this, R.string.net_error, Toast.LENGTH_SHORT).show();
                        } catch (Exception e1) {
