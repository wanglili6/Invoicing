...
public class RoleListFenPeiAdapter extends BaseAdapter {
    private Context mContext;
    private List<RoleBean.DataBean> mList;

    public RoleListFenPeiAdapter(Context mContext, List<RoleBean.DataBean> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.roleTvIsActivity.setVisibility(View.GONE);
