...
public class ShopEmployeeSwitchListAdapter extends BaseAdapter {
    private Context mContext;
    private List<EmployeeListBean.DataBean> mList;

    public ShopEmployeeSwitchListAdapter(Context mContext, List<EmployeeListBean.DataBean> mList) {
