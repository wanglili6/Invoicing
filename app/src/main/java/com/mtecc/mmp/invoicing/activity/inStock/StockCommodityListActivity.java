...
import com.mtecc.mmp.invoicing.activity.inStock.adapter.StockCommodityListAdapter;
 ...
 * 库存查看
 */
public class StockCommodityListActivity extends BaseActivity {
    ...
    private StockCommodityListAdapter commodityListAdapter;
    List<StockListBean.DataBean> mList = new ArrayList<>();
    int pagenum = 1;
    String isuseradmin = "";
    String proCode = "";
    String proName = "";
    ...
    public void initParms(Bundle parms) {
        ...
        commodityListAdapter = new StockCommodityListAdapter(this, mList, stockType);
        ...
        commodityListRecycleView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //选择批次
                Intent intent = new Intent(StockCommodityListActivity.this, StockBatchListActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString(InvoicingConstants.COMMODITY_Id, mList.get(position).getProId().getProId() + "");
                bundle.putString(InvoicingConstants.SHOP_ID, mList.get(position).getShopid().getShopid() + "");
                bundle.putString(InvoicingConstants.STOCK_TYPE, stockType);
...
//        commodityListRecycleView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false));
                ...
                case 1:
                    ...
                    if (null != data) {
                        ...
                        if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                            ...
                            Toast.makeText(StockCommodityListActivity.this, "解析二维码失败!", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void requestNetCommodityList(String page, String isuseradmin, final String proCode, final String proName, final String barcode, String cid, String shopid) {
        String url = InvoicingConstants.BASE_URL + InvoicingConstants.goodsStockList_URL;
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int id) {
                        try {
                            ...
                            Toast.makeText(StockCommodityListActivity.this, R.string.net_error, Toast.LENGTH_SHORT).show();
                        } catch (Exception e1) {
                    ...
                    public void onResponse(String response, int id) {
                        try {
                            ...
                            Gson gson = new Gson();
                            StockListBean stockListBean = gson.fromJson(response, StockListBean.class);
                            if (stockListBean != null) {
                                List<StockListBean.DataBean> dataList = stockListBean.getData();
                                if (dataList != null) {
