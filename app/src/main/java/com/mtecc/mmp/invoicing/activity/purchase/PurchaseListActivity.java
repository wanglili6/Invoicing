...
import com.mtecc.mmp.invoicing.activity.purchase.fragment.PurchaseIncomeFragment;
import com.mtecc.mmp.invoicing.activity.purchase.fragment.PurchaseOutFragment;
...
public class PurchaseListActivity extends BaseActivity {
    ...
    private String[] mTitles = {"进货历史", "退货历史"};
    ...
    public void initParms(Bundle parms) {
        ...
        tvTitle.setText("采购历史");
        PurchaseIncomeFragment incomeFragment = new PurchaseIncomeFragment();
        mFragments.add(incomeFragment);
        PurchaseOutFragment expendFragment = new PurchaseOutFragment();
