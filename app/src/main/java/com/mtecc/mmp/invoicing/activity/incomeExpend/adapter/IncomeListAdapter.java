...
public class IncomeListAdapter extends RecyclerView.Adapter<IncomeListAdapter.InComeExpendViewHolder> {
    private Context mContext;
    private ArrayList<String> list;

    public IncomeListAdapter(Context mContext, ArrayList<String> list) {
    ...
    public void onBindViewHolder(InComeExpendViewHolder holder, int position) {
        holder.incomeExpendImg.setBackgroundResource(R.mipmap.incomeing);
